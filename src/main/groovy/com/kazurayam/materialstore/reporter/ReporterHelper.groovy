...
class ReporterHelper {
     ...
     *
     * @return a css content which should be embeded in the HTML file generated by MaterialsBasicReporter and DiffArtifactsBasicReporter
     */
    static String loadStyleFromClasspath() {
        InputStream inputStream = getClass().getResourceAsStream(CSS_PATH)
        if (inputStream != null) {
